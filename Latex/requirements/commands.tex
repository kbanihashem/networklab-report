...
\newcommand{\teamMemOne}{اشکان ‌میرزایی%
}
\newcommand{\stdIdOne}{۹۶۱۰۹۶۵۲}

\newcommand{\teamMemTwo}{   امیرمجتبی صبور
}
\newcommand{\stdIdTwo}{۹۶۱۰۹۵۹۹}

\newcommand{\teamMemThree}{ کیارش بنی‌هاشم
}
\newcommand{\stdIdThree}{۹۶۱۰۹۹۶۳}
